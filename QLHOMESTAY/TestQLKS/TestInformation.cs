...
namespace TestQLKS
{
    internal class TestInforPageTest
    {
        ...
        public void SetUp()
        {
            ...
            Thread.Sleep(1000);
            driver.FindElement(By.Id("mat_khau")).SendKeys("Test@1243");
            Thread.Sleep(1000);
        ...
        {
            var testData = ReadTestData("C:\\Users\\vuduc\\Downloads\\DataTest_Nam.xlsx");
            int testCaseIndex = 1; 
            ...
            foreach (DataRow row in testData.Rows)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        UpdateTestResult("C:\\Users\\vuduc\\Downloads\\Testcase_Nam.xlsx", testCaseId, isNavigationSuccessful ? "Pass" : "Fail");
                    }
                }
                catch (Exception ex)
                {
                    ...
                    UpdateTestResult("C:\\Users\\vuduc\\Downloads\\Testcase_Nam.xlsx", testCaseId, "Fail");                   
                }
